...
export default function App() {
  ...
  const glassBg = useTransform(scrollYProgress, [0, 0.1], ["rgba(245,245,245,0.4)", "rgba(245,245,245,0.85)"]);
  ...
  return (
    <div className="bg-[#F5F5F5] text-[#1A1A1A] font-sans selection:bg-[#C8A24A] selection:text-white overflow-x-hidden">
      <style>{`
        ...
        /* Steady Parallax - Background and Text fixed while page scrolls */
        ...
        .reveal-footer-container { position: relative; z-index: 30; background: #F5F5F5; box-shadow: 0 50px 150px rgba(0,0,0,0.6); }
        ...
        @keyframes linear-flow { 0% { offset-distance: 0%; opacity: 0; } 10% { opacity: 1; } 90% { opacity: 1; } 100% { offset-distance: 100%; opacity: 0; } }
        .energy-pulse { animation: linear-flow 6s infinite linear; }
        
        @keyframes spin-slow { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
        .animate-spin-slow { animation: spin-slow 40s linear infinite; }
        .animate-spin-slow-reverse { animation: spin-slow 55s linear infinite reverse; }
      `}</style>

      {/* INDEPENDENT LOGO (MOBILE OPTIMIZED SIZE) */}
      <div className="fixed top-4 left-4 md:top-12 md:left-12 z-[110]">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="w-20 h-20 md:w-[180px] md:h-[180px]">
          <img src="logo.gif" alt="Square Connect" className="w-full h-full object-contain" style={{ background: 'transparent' }} />
        </motion.div>
      </div>

      {/* FROZEN GLASS HEADER MENU (MOBILE DRAWER INTEGRATED) */}
      ...
      <div className="reveal-footer-container">
        ...
        {/* 1. HERO - MOBILE OPTIMIZED TYPOGRAPHY */}
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              <Reveal>
                ...
                <div className="mt-8 md:mt-12">
                  <a href="#transformation" className="px-10 md:px-16 py-6 md:py-8 bg-[#C8A24A] text-[#1A1A1A] text-[10px] md:text-xs font-black tracking-[0.4em] uppercase hover:bg-[#1A1A1A] hover:text-white transition-all duration-500 shadow-2xl">EXPLORE THE BRIDGE</a>
                </div>
              </Reveal>
            </div>
            <div className="lg:col-span-5 flex justify-center relative scale-75 md:scale-100 mt-10 md:mt-0">
               <div className="relative w-[320px] h-[320px] md:w-[600px] md:h-[600px]">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                     <div className="w-[250px] h-[250px] md:w-[380px] md:h-[380px] bg-white border border-black/5 rounded-full flex flex-col items-center justify-center shadow-2xl overflow-hidden">
        ...
        <section className="parallax-window">
           <div className="parallax-fixed-content">
              ...
              <div className="relative z-10 text-center px-6">
                <Reveal y={60}>
                  <h2 className="font-serif-display text-4xl md:text-5xl lg:text-[140px] tracking-tighter uppercase font-bold text-white leading-none">FROM FRAGMENTATION<br />TO STRUCTURE.</h2>
                  <div className="mt-8 md:mt-12 text-[#C8A24A] text-[9px] md:text-[11px] tracking-[1.5em] md:tracking-[2em] font-black uppercase">MASTER ARCHITECTURE</div>
                </Reveal>
              </div>
           </div>
        </section>
        ...
        {/* 3. PROBLEM SECTION */}
        <section className="py-20 md:py-64 bg-[#F5F5F5] relative z-10 shadow-2xl border-y border-black/5">
          <div className="container mx-auto max-w-7xl px-6 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-end mb-24 md:mb-40 reveal">
              <div className="text-left">
                ...
                <h2 className="font-serif-display text-5xl md:text-7xl lg:text-9xl tracking-tight leading-[0.9] text-[#1A1A1A]">It's hard to do<br />it yourself.</h2>
              </div>
              <div className="max-w-xl text-left"><p className="text-[#1A1A1A]/50 text-lg md:text-2xl font-light leading-relaxed border-l-2 border-[#C8A24A]/40 pl-6 md:pl-12 italic">Managing six different specialists on your own is exhausting. The traditional system is fundamentally broken.</p></div>
            </div>
            <div className="grid md:grid-cols-3 gap-6 md:grid-cols-3 md:gap-12">
              {["TOO MANY MEETINGS", "NO COMMUNICATION", "UNNECESSARY RISK"].map((t, idx) => (
                <div key={idx} className="relative p-10 md:p-16 bg-white border border-[#1A1A1A]/5 hover:border-[#C8A24A]/40 transition-all duration-700 group overflow-hidden shadow-sm hover:shadow-2xl">
                  ...
                  <div className="relative z-10 mt-12 md:mt-20">
                    <h3 className="text-[12px] md:text-[13px] font-black tracking-[0.3em] md:tracking-[0.4em] uppercase mb-6 md:mb-10 text-[#1A1A1A]">{t}</h3>
        ...
        {/* 4. THE LIVE BRIDGE (MOBILE RESPONSIVE SVG) */}
        <section id="transformation" className="min-h-[120vh] md:min-h-[180vh] py-24 md:py-56 bg-white relative overflow-hidden flex flex-col justify-center">
          ...
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
            <div className="text-center mb-24 md:mb-40 reveal">
               <span className="text-[10px] md:text-[11px] tracking-[1em] uppercase text-[#C8A24A] font-black mb-8 block">THE TRANSFORMATION</span>
               <h2 className="font-serif-display text-6xl md:text-8xl lg:text-[140px] leading-[0.9] md:leading-[0.8] tracking-tighter text-[#1A1A1A] uppercase">One Source.<br /><span className="text-[#C8A24A] italic font-light lowercase leading-none">The Bridge.</span></h2>
            </div>
            <div className="grid lg:grid-cols-12 gap-12 md:gap-20 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col gap-6 md:gap-8 md:pt-10">
                {engines.map((e, i) => (
                  <div key={i} className="p-8 md:p-12 border border-[#1A1A1A]/5 bg-white transition-all hover:border-[#C8A24A] hover:translate-x-4 shadow-sm group">
                    <h3 className="font-serif-display text-4xl md:text-5xl mb-4 md:mb-6 uppercase group-hover:text-[#1A1A1A] leading-none">{e.title}</h3>
        ...
        {/* 5. METHODOLOGY (MOBILE OPTIMIZED) */}
        <section id="methodology" className="py-20 md:py-56 bg-[#F5F5F5] border-b border-[#1A1A1A]/5 relative z-10 shadow-2xl">
            ...
            <div className="grid md:grid-cols-3 gap-12 md:gap-24 mt-20 md:mt-32">
              {[
                ...
                <div key={i} className="reveal group text-left">
                   <div className="text-[12px] md:text-[14px] font-black tracking-[0.3em] text-[#C8A24A] mb-6 md:mb-10 block">0{step.id}</div>
                   <h3 className="text-lg md:text-[16px] font-black tracking-[0.3em] md:tracking-[0.4em] uppercase mb-6 md:mb-10 text-[#1A1A1A] group-hover:text-[#C8A24A] transition-colors duration-700">{step.t}</h3>
                   <p className="text-sm md:text-sm text-[#1A1A1A]/50 leading-relaxed font-light max-w-xs">{step.d}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="parallax-window">
           <div className="parallax-fixed-content">
              ...
              <div className="relative z-10 text-center px-6">
                <Reveal y={60}>
                  <h2 className="font-serif-display text-4xl md:text-5xl lg:text-[140px] tracking-tighter uppercase font-bold text-white leading-none text-center">BEYOND FRAGMENTATION<br /><span className="text-[#C8A24A] italic font-light lowercase capitalize leading-none opacity-80 text-6xl md:text-[100px]">Unified Execution.</span></h2>
                </Reveal>
              </div>
           </div>
        </section>
        ...
        {/* 7. THE SYSTEM */}
        <section id="system" className="py-24 md:py-72 bg-white relative overflow-hidden flex flex-col justify-center z-10 shadow-2xl">
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 relative z-10 text-ink text-center max-w-4xl mx-auto mb-16 md:mb-32">
            <span className="text-[10px] md:text-[11px] tracking-[1em] uppercase text-[#C8A24A] font-black mb-8 block">THE SYSTEM</span>
            <h2 className="font-serif-display text-5xl md:text-9xl lg:text-[120px] leading-[0.9] md:leading-[0.8] tracking-tighter mb-8 md:mb-10 text-[#1A1A1A]">How We Operate.</h2>
            <p className="text-[#1A1A1A]/40 text-lg md:text-xl font-light leading-relaxed uppercase tracking-[0.4em]">Engineered for speed and absolute precision.</p>
          </div>
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 space-y-24 md:space-y-72 mt-10 md:mt-32 relative z-10">
              {[
                ...
                <div key={idx} className={`grid md:grid-cols-2 gap-12 lg:gap-40 items-center reveal ${step.side === 'left' ? 'md:flex-row-reverse' : ''}`}>
                  <div className="text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 max-w-6xl mx-auto">
              {[
                ...
                <div key={i} className="text-center p-12 md:p-16 border border-white/10 bg-white/5 backdrop-blur-md hover:border-[#C8A24A]/40 transition-all duration-700 group shadow-xl">
                  <div className="flex justify-center mb-8 md:mb-10"><s.i size={44} className="text-[#C8A24A]/40 group-hover:text-[#C8A24A] transition-colors" /></div>
                  <div className="font-serif-display text-7xl lg:text-[130px] text-[#C8A24A] mb-4 md:mb-6 leading-none"><Counter end={s.v} suffix={s.s} /></div>
                  <p className="text-[10px] md:text-[12px] tracking-[0.4em] md:tracking-[0.5em] uppercase font-black text-white/30 group-hover:text-white/60">{s.l}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* 9. THE ECOSYSTEM (BENTO GRID CAPABILITIES) */}
        <section id="ecosystem" className="py-24 md:py-72 bg-[#F5F5F5] relative overflow-hidden z-10 shadow-2xl border-y border-black/5">
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 text-center mb-24 md:mb-40 reveal">
            <span className="text-[10px] md:text-[11px] tracking-[1em] md:tracking-[1.2em] text-[#C8A24A] font-black block mb-10 md:mb-12 uppercase">OUR CAPABILITIES</span>
            <h2 className="font-serif-display text-6xl md:text-8xl lg:text-[140px] tracking-tighter uppercase leading-[0.9] md:leading-[0.8] text-[#1A1A1A]">The Ecosystem.</h2>
          </div>
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 auto-rows-fr">
            {engines.map((engine, i) => (
              <motion.div key={i} className={`${engine.span} relative group bg-white border border-[#1A1A1A]/5 p-10 md:p-16 transition-all duration-700 hover:shadow-2xl overflow-hidden flex flex-col justify-between`}>
                <div className="absolute inset-0 z-0">
                    <img src={engine.img} alt="" className="w-full h-full object-cover opacity-0 md:group-hover:opacity-30 md:group-hover:scale-110 grayscale transition-all duration-1000" />
                    <div className="absolute inset-0 bg-white opacity-100 md:group-hover:opacity-70 transition-opacity duration-700" />
                </div>
                <div className="relative z-10 flex flex-col h-full justify-between text-left">
                  <div>
                    <div className="w-12 h-12 md:w-16 md:h-16 border-2 border-[#C8A24A]/30 flex items-center justify-center mb-10 md:mb-16 bg-[#C8A24A]/5 group-hover:bg-[#C8A24A] transition-all">
                      <engine.icon size={24} strokeWidth={1} className="text-[#C8A24A] group-hover:text-white" />
                    </div>
                    <h3 className="font-serif-display text-4xl md:text-6xl mb-4 md:mb-6 uppercase tracking-tighter leading-none text-[#1A1A1A]">{engine.label}</h3>
        ...
        {/* 10. 3D VAULT (MOBILE OPTIMIZED SCALING) */}
        <section className="py-24 md:py-80 bg-[#1A1A1A] text-white relative overflow-hidden border-y border-white/5">
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 grid lg:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            <div className="flex justify-center items-center py-12 md:py-20 relative scale-75 md:scale-110">
               <div className="cube-container relative w-[300px] h-[300px] md:w-[500px] md:h-[500px]">
                  ...
                  <motion.div animate={{ rotateX: -360, rotateZ: 360 }} transition={{ duration: 15, repeat: Infinity, ease: "linear" }} className="absolute inset-12 md:inset-20 border-2 border-[#C8A24A]/40 flex items-center justify-center" />
                  <div className="absolute inset-0 flex items-center justify-center">
                     <div className="w-28 h-28 md:w-56 md:h-56 bg-[#C8A24A]/10 border border-[#C8A24A]/60 flex items-center justify-center gold-glow backdrop-blur-3xl group cursor-pointer hover:scale-110 transition-all duration-700 shadow-[0_0_100px_rgba(200,162,74,0.1)]">
        ...
        {/* 11. FOUNDER SECTION */}
        <section id="founder" className="py-20 md:py-[30vh] bg-[#F5F5F5] border-t border-[#1A1A1A]/5 relative z-10 shadow-2xl text-ink">
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 grid lg:grid-cols-2 gap-12 md:gap-48 items-center text-left">
            <Reveal x={-50}>
              <div className="relative w-full max-w-md aspect-[4/5] bg-[#1A1A1A] border border-white/5 p-8 md:p-12 flex flex-col justify-end shadow-3xl group overflow-hidden">
                ...
                <div className="relative z-20 text-left">
                  <span className="text-[9px] md:text-[10px] tracking-[0.6em] md:tracking-[0.8em] uppercase text-[#C8A24A] font-black block mb-6 md:mb-10">THE MASTER ARCHITECT</span>
            ...
            <div className="reveal text-left">
              ...
              <a href="#contact" className="group inline-flex items-center gap-6 md:gap-10 text-[11px] md:text-[12px] tracking-[0.6em] md:tracking-[1em] uppercase text-[#1A1A1A] font-black border-b-2 border-black/10 pb-6 md:pb-8 hover:border-[#C8A24A] transition-all duration-500">
                LET'S CONNECT <ArrowRight size={20} md:size={24} className="text-[#C8A24A] transition-transform md:group-hover:translate-x-4" />
              </a>
            </div>
          </div>
        </section>
        ...
        {/* 12. HAPPY CLIENTS */}
        <section id="results" className="py-24 md:py-64 bg-white border-t border-[#1A1A1A]/5 text-ink relative z-10 shadow-2xl text-left">
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 text-center mb-24 md:mb-40 reveal">
            <span className="text-[10px] md:text-[11px] tracking-[1.5em] uppercase text-[#C8A24A] font-black mb-10 md:mb-12 block uppercase">RESULTS</span>
            <h2 className="font-serif-display text-5xl md:text-8xl lg:text-[130px] tracking-tighter uppercase font-bold leading-none text-[#1A1A1A]">Happy Clients.</h2>
          </div>
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 grid md:grid-cols-2 gap-x-12 md:gap-x-20 gap-y-24 md:gap-y-40 text-left">
            {testimonials.map((test, i) => (
              <motion.div key={i} className="flex flex-col group text-left">
                <div className="relative p-8 md:p-16 lg:p-20 bg-[#F5F5F5] border border-[#1A1A1A]/5 shadow-xl transition-all duration-700 md:group-hover:shadow-2xl md:group-hover:-translate-y-4 text-left">
                  <div className="absolute top-6 right-6 md:top-10 md:right-10 text-[#C8A24A]/10 text-left"><Quote size={48} md:size={80} strokeWidth={1} /></div>
                  <p className="font-serif-display text-2xl md:text-4xl lg:text-5xl text-[#1A1A1A] relative z-10 leading-[1.2] mb-6 italic font-light text-left">
                    "{test.quote}"
                  </p>
                  <div className="bubble-tip text-left" />
                </div>
                <div className="flex items-center gap-6 md:gap-10 mt-12 md:mt-20 ml-6 md:ml-20 text-left">
                  <div className="relative w-16 h-16 md:w-28 md:h-28 rounded-full border-2 border-[#C8A24A]/30 overflow-hidden flex items-center justify-center bg-stone-100 group-hover:border-[#C8A24A] transition-all duration-500 shadow-xl">
                  ...
                  <div className="text-left">
                    <h4 className="text-sm md:text-xl font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-[#1A1A1A]">{test.name}</h4>
                    <p className="text-[9px] md:text-[11px] text-[#C8A24A] uppercase font-black tracking-[0.4em] md:tracking-[0.6em] italic mt-2 md:mt-3">{test.title}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <section id="guarantee" className="py-24 md:py-72 bg-[#1A1A1A] border-y border-white/5 relative overflow-hidden text-white z-0 shadow-2xl text-center">
          <div className="container mx-auto max-w-7xl px-6 lg:px-12 relative z-10 text-center">
            <Reveal>
              <span className="text-[10px] md:text-[11px] tracking-[1em] md:tracking-[1.5em] uppercase text-[#C8A24A] font-black mb-10 md:mb-12 block uppercase">OUR GUARANTEE</span>
              <h2 className="font-serif-display text-5xl md:text-8xl lg:text-[130px] tracking-tighter uppercase font-bold leading-[1] mb-16 md:mb-24 text-white">ZERO HIDDEN FEES.<br /><span className="italic font-light lowercase capitalize leading-none opacity-80 text-white">Total Transparency.</span></h2>
            </Reveal>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-20 text-center">
                {[
                  ...
                  <div key={idx} className="flex flex-col items-center group text-center">
                    <item.icn size={40} md:size={64} strokeWidth={1} className="text-[#C8A24A] mb-8 md:mb-12 md:group-hover:scale-110 transition-transform duration-700" />
                    <span className="text-[9px] md:text-[13px] font-black uppercase tracking-[0.4em] md:tracking-[0.6em] text-white/50 group-hover:text-[#C8A24A] transition-all">{item.lbl}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section id="faq" className="py-20 md:py-56 bg-[#1A1A1A] border-t border-white/5 text-white text-left">
          <div className="container mx-auto max-w-4xl px-6 text-center mb-16 md:mb-32">
            <span className="text-[10px] md:text-[11px] tracking-[1.2em] md:tracking-[1.5em] uppercase text-[#C8A24A] font-black mb-10 block uppercase">CLARITY</span>
            <h2 className="font-serif-display text-6xl md:text-8xl lg:text-[130px] tracking-tighter uppercase text-white/95 leading-none">Questions.</h2>
          </div>
          <div className="container mx-auto max-w-4xl px-6 space-y-4 text-left">
            {faqs.map((faq, i) => (
              <div key={i} className={`border border-white/10 transition-all duration-700 ${openFaq === i ? 'bg-white/5 border-[#C8A24A]/40' : 'bg-transparent'}`}>
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full p-8 md:p-12 flex justify-between items-center text-left hover:bg-white/5 transition-all">
                  <h4 className="text-sm md:text-lg font-black uppercase tracking-[0.2em] md:tracking-[0.3em] pr-6">{faq.q}</h4>
                  <Plus className={`text-[#C8A24A] transition-transform duration-500 ${openFaq === i ? 'rotate-45 scale-125' : ''}`} size={24} md:size={28} />
                </button>
                <AnimatePresence>
                  {openFaq === i && (
                    <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden">
                      <p className="px-8 md:px-12 pb-8 md:pb-12 text-sm md:text-lg text-white/40 leading-relaxed font-light italic border-l-2 border-[#C8A24A]/20 ml-8 md:ml-12">{faq.a}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
        ...
        <section id="contact" className="py-24 md:py-[35vh] bg-[#F5F5F5] text-center border-b border-[#1A1A1A]/10 shadow-[0_100px_200px_rgba(0,0,0,0.6)] relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-6xl px-6 relative z-10 text-center">
            <Reveal>
              <span className="text-[10px] md:text-[12px] tracking-[1.5em] md:tracking-[2.5em] text-[#C8A24A] font-black block mb-12 md:mb-20 uppercase pl-4 md:pl-8 text-center">PRIVATE ACCESS</span>
              <h2 className="font-serif-display text-6xl md:text-8xl lg:text-[220px] uppercase mb-12 md:mb-20 font-bold leading-none tracking-tighter text-[#1A1A1A]">Final Step.</h2>
              <p className="text-2xl md:text-4xl lg:text-7xl font-serif-display text-[#C8A24A] mb-20 md:mb-40 italic font-light leading-snug">Ready to build your bridge?<br />Secure your unified future now.</p>
              <form className="flex flex-col sm:flex-row gap-4 md:gap-8 max-w-5xl mx-auto mb-16 md:mb-20" onSubmit={(e) => e.preventDefault()}>
                <input type="email" placeholder="YOUR EMAIL ADDRESS" required className="flex-1 bg-white border-2 border-black/10 px-8 md:px-16 py-6 md:py-10 text-sm md:text-lg font-bold tracking-widest outline-none focus:border-[#C8A24A] transition-all rounded-none text-ink" />
                <button type="submit" className="bg-[#C8A24A] text-[#1A1A1A] px-10 md:px-24 py-6 md:py-10 text-[11px] md:text-[14px] font-black tracking-[0.4em] md:tracking-[0.6em] uppercase hover:bg-black hover:text-white transition-all duration-700 shadow-3xl">REQUEST ACCESS</button>
              </form>
              <p className="text-[#1A1A1A]/30 text-[10px] md:text-[12px] tracking-[0.8em] md:tracking-[1.5em] font-black uppercase">CONFIDENTIALITY ASSURED • ADVISORY COVERAGE</p>
            </Reveal>
          </div>
        </section>
      </div>
      ...
      <footer className="sticky-footer py-24 md:py-32 bg-[#1A1A1A] text-white">
        <div className="container mx-auto max-w-7xl px-6 lg:px-12 grid md:grid-cols-4 gap-16 md:gap-24 text-white/90 relative z-10 text-left">
          <div className="col-span-1">
            <div className="w-24 md:w-32 h-24 md:h-32 mb-10 md:mb-16">
               <img src="logo.gif" alt="Square Connect" className="w-full h-full object-contain filter grayscale brightness-200" />
            </div>
            <p className="text-[10px] md:text-[11px] tracking-[0.6em] md:tracking-[0.8em] text-white/40 font-black uppercase leading-relaxed text-left">UNIFIED INTELLIGENCE<br />ADVISORY GROUP</p>
          </div>
          <div className="col-span-1 text-left">
            <h4 className="text-[11px] md:text-[12px] text-[#C8A24A] mb-8 md:mb-12 font-black uppercase tracking-[0.5em]">Office</h4>
            <p className="text-sm md:text-base text-white/40 leading-relaxed font-bold uppercase tracking-widest">1644 Logan Road,<br />Mount Gravatt QLD 4122</p>
          </div>
          <div className="col-span-1 text-left">
            <h4 className="text-[11px] md:text-[12px] text-[#C8A24A] mb-8 md:mb-12 font-black uppercase tracking-[0.5em]">Channels</h4>
            <div className="flex flex-col gap-6 md:gap-8 text-[11px] text-white/40 font-black tracking-[0.4em] md:tracking-[0.6em] uppercase font-bold text-left">
          ...
          <div className="col-span-1 flex flex-col justify-between items-start md:items-end text-left md:text-right">
             <div className="flex gap-10 md:gap-12 text-[10px] md:text-[11px] text-white/20 uppercase font-black tracking-[0.6em] md:tracking-[0.8em] mb-16 md:mb-0">
                <a href="#" className="hover:text-[#C8A24A] transition-all">Privacy</a>
                <a href="#" className="hover:text-[#C8A24A] transition-all">Terms</a>
             </div>
             <p className="text-[9px] md:text-[11px] text-white/10 uppercase font-black tracking-[0.4em]">© 2026 SQUARE CONNECT ADVISORY GROUP</p>
          </div>
        </div>
      </footer>
    </div>
